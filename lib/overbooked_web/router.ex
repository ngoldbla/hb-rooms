defmodule OverbookedWeb.Router do
  ...
  scope "/", OverbookedWeb do
    ...
    live_session :default,
      on_mount: [{OverbookedWeb.UserAuth, :default}] do
    ...
    live_session :authenticated,
      ...
      live "/", HomeLive, :index
      live "/schedule/monthly", ScheduleMonthlyLive, :index
      live "/schedule/weekly", ScheduleWeeklyLive, :index
    ...
    live_session :admin,
      ...
      live "/admin/desks", AdminDesksLive, :index
      live "/admin/rooms", AdminRoomsLive, :index
