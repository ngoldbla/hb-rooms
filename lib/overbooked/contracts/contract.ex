defmodule Overbooked.Contracts.Contract do
  ...
  schema "contracts" do
    ...
    field :expiration_warning_sent_at, :utc_datetime
  ...
  @optional_fields [:status, :stripe_checkout_session_id, :stripe_payment_intent_id, :stripe_customer_id, :refund_amount_cents, :refund_id, :refunded_at, :accepted_terms_version, :terms_accepted_at, :expiration_warning_sent_at]
